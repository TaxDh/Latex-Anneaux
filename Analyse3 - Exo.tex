...
\begin{rem}
Si $E$ est un espace de Banach et $F \subset E$ et $F$ est fermé, alors $F$ est un espace de Banach.
\end{rem}

\begin{rem}
Soit $E$ un \evn normé, on sait que $\bar{B} (0,1)$ est compact, comme $S^1 \subset \bar{B} $ est fermé, alors $S^1$ est compact.
\end{rem}
